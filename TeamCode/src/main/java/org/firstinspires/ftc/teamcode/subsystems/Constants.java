...
public class Constants {
    ...
    public enum autoActions{
        READY,                      //MOVE FROM START POSITION TO READY POSITION TO MOVE TO START AUTONOMOUS
        ...
        BACK_TO_HIGH_JUNC,          //MOVE BACKWARD TOWARDS HIGH JUNC
        TURN_TO_HIGH_JUNC,          //TURN 90 DEGREES COUNTERCLOCKWISE FACING HIGH JUNC
        FORWARD_TO_HIGH_JUNC,       //MOVE FORWARDS TO HIGH JUNC // ONLY USED AFTER PRE-LOAD
